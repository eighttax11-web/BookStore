        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarritoSesionGuid = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarritoSesionId = table.Column<int>(nullable: true),
                    CarritoSesionDetalleGuid = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
